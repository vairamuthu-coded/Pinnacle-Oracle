                    ...
                    if (Class.Users.COMPCODE > 1)
                    {
                        ...
                        if (dt1 == null || dt1.Rows.Count<=0)
                        {
                            ...
                            "CREATE OR REPLACE TRIGGER " + Class.Users.ProjectID + ".ASPTBLMENUNAMETRI BEFORE INSERT ON ASPTBLMENUNAME REFERENCING NEW AS NEW OLD AS OLD FOR EACH ROW DECLARE MENUNAMEID  INTEGER; BEGIN  MENUNAMEID:= 0; SELECT " + Class.Users.ProjectID + ".ASPTBLMENUNAMESEQ.NEXTVAL INTO MENUNAMEID FROM DUAL; :NEW.MENUNAMEID:= MENUNAMEID; END ASPTBLMENUNAMETRI;?" +
                             "CREATE TABLE " + Class.Users.ProjectID + ".ASPINVENTRY(INVENTRYID  INTEGER,  QRCODE      VARCHAR2(100 BYTE),  SYSTEMDATE  VARCHAR2(50 BYTE),  SYSTEMTIME  VARCHAR2(50 BYTE),  COMPCODE    INTEGER,  USERNAME    INTEGER,  MODIFIED    VARCHAR2(30 BYTE),  CREATEDON   VARCHAR2(30 BYTE),  IPADDRESS   VARCHAR2(100 BYTE),  GATENAME    VARCHAR2(50 BYTE),  CATEGORY    VARCHAR2(5 BYTE),  GATEDCNO    VARCHAR2(50 BYTE),  FINYEAR     INTEGER,  PASSMISSED  VARCHAR2(1 BYTE))?" +
                           ...
                           "CREATE TABLE " + Class.Users.ProjectID + ".ASPTBLUSERRIGHTS  (USERRIGHTSID  INTEGER  NOT NULL,  MENUID  INTEGER NOT NULL,  MENUNAME  VARCHAR2(100 BYTE),  NAVURL  VARCHAR2(100 BYTE),  PARENTMENUID  INTEGER,  ACTIVE  VARCHAR2(1 BYTE),  SAVES  VARCHAR2(1 BYTE),  PRINTS  VARCHAR2(1 BYTE),  READONLY   VARCHAR2(1 BYTE),  SEARCH  VARCHAR2(1 BYTE),  DELETES VARCHAR2(1 BYTE),  USERNAME   INTEGER NOT NULL,  COMPCODE   INTEGER NOT NULL,  PASSWORDS  VARCHAR2(50 BYTE),  SNO  INTEGER,  IPADDRESS  VARCHAR2(30 BYTE),  CREATEDBY  VARCHAR2(30 BYTE),  CREATEDON VARCHAR2(50 BYTE),MODIFIEDON  VARCHAR2(30 BYTE),  NEWS VARCHAR2(10 BYTE),  TREEBUTTON VARCHAR2(50 BYTE),  GLOBALSEARCH  VARCHAR2(50 BYTE),  LOGIN   VARCHAR2(50 BYTE),  CHANGEPASSWORD   VARCHAR2(50 BYTE),  CHANGESKIN VARCHAR2(50 BYTE),  DOWNLOAD   VARCHAR2(50 BYTE),  CONTACT VARCHAR2(50 BYTE),  PDF   VARCHAR2(50 BYTE),  IMPORTS VARCHAR2(50 BYTE),FOREIGN KEY(username) REFERENCES asptblusermas (userid) )?" +
                            ...
                            "INSERT INTO " + Class.Users.ProjectID + ".ASPTBLUSERRIGHTS(MENUID ,  MENUNAME,  NAVURL,  PARENTMENUID ,  ACTIVE,NEWS, SAVES, PRINTS,  READONLY ,  SEARCH ,  DELETES,COMPCODE,USERNAME,TREEBUTTON,GLOBALSEARCH,LOGIN,CHANGEPASSWORD, CHANGESKIN,DOWNLOAD,CONTACT,PDF,IMPORTS,CREATEDON,MODIFIEDON,SNO,IPADDRESS ) VALUES(12,'DataImport','Transactions',3,'F','T','T','T','T','T','T', '" + Class.Users.COMPCODE + "' ,1,'F','F','F','F','F','F','F','F','F',TO_DATE('28/01/2021 11:49:59', 'dd/MM/yyyy hh24:MI:SS'),TO_DATE('28/01/2021 11:49:59', 'dd/MM/yyyy hh24:MI:SS'),0,'" + Class.Users.IPADDRESS + "')? " +
