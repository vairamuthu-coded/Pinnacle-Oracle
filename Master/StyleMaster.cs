    ...
    public partial class StyleMaster : Form,ToolStripAccess
    {
        ...
        public void Saves()
        {
            try
            {
                if (txtstylename.Text != "")
                {
                    ...
                    if (va.IsString(txtstylename.Text) == true)
                    {

                        string chk = "";
                        if (checkactive.Checked == true) { chk = "T"; } else { chk = "F"; checkactive.Checked = false; }
                        string sel = "select ASPTBLSTYMASID    from  ASPTBLSTYMAS    WHERE STYLENAME='" + txtstylename.Text + "' and active='" + chk + "' ";
                        ...
                        {
                            string ins = "insert into ASPTBLSTYMAS(STYLENAME,active,createdby,modifiedby,IPADDRESS)  VALUES('" + txtstylename.Text.ToUpper() + "','" + chk + "','" + Class.Users.HUserName + "','" + Class.Users.HUserName + "','" + Class.Users.IPADDRESS + "' )";
                        ...
                        {
                            string up = "update  ASPTBLSTYMAS  set   STYLENAME='" + txtstylename.Text.ToUpper() + "' , active='" + chk + "' , modifiedby='" + Class.Users.HUserName + "',ipaddress='" + Class.Users.IPADDRESS + "' where ASPTBLSTYMASID='" + txtstyleid.Text + "'";
        ...
        public void GridLoad()
        {
            try
            {
                ...
                string sel1 = " select a.ASPTBLSTYMASID, a.STYLENAME  , a.active  from  ASPTBLSTYMAS a   order by 1";
        ...
        private void ListView1_ItemActivate(object sender, EventArgs e)
        {
            try
            {
                ...
                if (listView1.Items.Count > 0)
                {
                    ...
                    txtstyleid.Text = listView1.SelectedItems[0].SubItems[1].Text;
                    string sel1 = " select a.ASPTBLSTYMASID, a.STYLENAME  , a.active    from  ASPTBLSTYMAS a    where a.ASPTBLSTYMASID=" + txtstyleid.Text;
                    DataSet ds = Utility.ExecuteSelectQuery(sel1, "ASPTBLSTYMAS");
                    DataTable dt = ds.Tables["ASPTBLSTYMAS"];
        ...
        public void Deletes()
        {
            if (txtstyleid.Text != "")
            {
                string sel1 = "select a.ASPTBLSTYMASID from ASPTBLSTYMAS a join ASPTBLBUYSAM b on a.ASPTBLSTYMASID=b.STYLE where a.ASPTBLSTYMASID='" + txtstyleid.Text + "'";
                DataSet ds = Utility.ExecuteSelectQuery(sel1, "ASPTBLSTYMAS");
                DataTable dt = ds.Tables["ASPTBLSTYMAS"];
                if (dt.Rows.Count > 0)
                {
