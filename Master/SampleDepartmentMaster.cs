...
{
    public partial class SampleDepartmentMaster : Form,ToolStripAccess
    {
        private static SampleDepartmentMaster _instance;
        Models.Master mas = new Models.Master();
        Models.UserRights sm = new Models.UserRights();
        ListView listfilter = new ListView();
        public static SampleDepartmentMaster Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new SampleDepartmentMaster();

                GlobalVariables.CurrentForm = _instance; return _instance;
            }
        }
        public SampleDepartmentMaster()
        {
            InitializeComponent();
        ...
        public void Saves()
        {
            try
            {
                if (txtdept.Text != "")
                {
                        ...
                        string sel = "select ASPTBLSAMDEPTMASID    from  ASPTBLSAMDEPTMAS    WHERE DEPARTMENT='" + txtdept.Text + "' and active='" + chk + "' ";
                        ...
                        {
                            string ins = "insert into ASPTBLSAMDEPTMAS(DEPARTMENT,active,createdby,modifiedby,ipaddress)  VALUES('" + txtdept.Text.ToUpper() + "','" + chk + "','" + Class.Users.HUserName + "','" + Class.Users.HUserName + "','" + Class.Users.IPADDRESS + "' )";
                        ...
                        {
                            string up = "update  ASPTBLSAMDEPTMAS  set   DEPARTMENT='" + txtdept.Text.ToUpper() + "' , active='" + chk + "' , modifiedby='" + Class.Users.HUserName + "',ipaddress='" + Class.Users.IPADDRESS + "' where ASPTBLSAMDEPTMASID='" + txtdeptid.Text + "'";
        ...
        public void GridLoad()
        {
            try
            {
                ...
                string sel1 = " select a.ASPTBLSAMDEPTMASID, a.DEPARTMENT  , a.active  from  ASPTBLSAMDEPTMAS a   order by 1";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow myRow in dt.Rows)
                    {
                        ...
                        list.SubItems.Add(myRow["ASPTBLSAMDEPTMASID"].ToString());
        ...
        private void ListView1_ItemActivate(object sender, EventArgs e)
        {
            try
            {
                ...
                if (listView1.Items.Count > 0)
                {
                    ...
                    string sel1 = " select a.ASPTBLSAMDEPTMASID, a.DEPARTMENT , a.active    from  ASPTBLSAMDEPTMAS a    where a.ASPTBLSAMDEPTMASID=" + txtdeptid.Text;
                    DataSet ds = Utility.ExecuteSelectQuery(sel1, "ASPTBLSAMDEPTMAS");
                    DataTable dt = ds.Tables["ASPTBLSAMDEPTMAS"];

                    if (dt.Rows.Count > 0)
                    {
                        txtdeptid.Text = Convert.ToString(dt.Rows[0]["ASPTBLSAMDEPTMASID"].ToString());
        ...
        public void Deletes()
        {
            if (txtdeptid.Text != "")
            {
                string sel1 = "select a.ASPTBLSAMDEPTMASID from ASPTBLSAMDEPTMAS a join ASPTBLSAMCATMAS b on a.ASPTBLSAMDEPTMASID=b.DEPARTMENT where a.ASPTBLSAMDEPTMASID='" + txtdeptid.Text + "'";
                DataSet ds = Utility.ExecuteSelectQuery(sel1, "ASPTBLSAMDEPTMAS");
                DataTable dt = ds.Tables["ASPTBLSAMDEPTMAS"];
                if (dt.Rows.Count > 0)
                {
                ...
                else
                {
                    ...
                    string del = "delete from ASPTBLSAMDEPTMAS where ASPTBLSAMDEPTMASID='" + Convert.ToInt64("0" + txtdeptid.Text) + "'";
