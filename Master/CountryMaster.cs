...
namespace Pinnacle.Master
{
    public partial class CountryMaster : Form,ToolStripAccess
    {
        ...
        {
            GridLoad(); butheader.Text = Class.Users.ScreenName;
            panel2.BackColor = Class.Users.BackColors;
            panel3.BackColor = Class.Users.BackColors;
            butheader.BackColor = Class.Users.BackColors; txtcountry.Select();
            butfooter.BackColor = Class.Users.BackColors;empty();
        }
        ...
        public void GridLoad()
        {
            try
            {
                ...
                string sel1 = "select a.GTCOUNTRYMASTID, a.countryname as  country , a.active  from  GTCOUNTRYMAST a   order by 1";
        ...
        public void Search()
        {
            try
            {
                if (txtsearch.Text.ToUpper() != "")
                {
                    ...
                    string sel1 = "  SELECT  a.GTCOUNTRYMASTID,a.countryname as country,a.active from GTCOUNTRYMAST a  where a.countryname LIKE'%" + txtsearch.Text.ToUpper() + "%' ";
                    DataSet ds = Utility.ExecuteSelectQuery(sel1, "GTCOUNTRYMAST");
                    DataTable dt = ds.Tables["GTCOUNTRYMAST"];
                    if (dt.Rows.Count > 0)
                    {
