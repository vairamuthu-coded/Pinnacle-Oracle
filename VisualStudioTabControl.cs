...
namespace Pinnacle
{
    ...
    public class VisualStudioTabControl : TabControl
    {
        ...
        /// </summary>
        private Color backTabColor = SystemColors.Window;
                ...
                for (var i = 0; i < this.TabCount; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (GlobalVariables.TabCtrl.TabPages.Count <= 0)
                        {
                            ...
                            GlobalVariables.MdiPanel.Visible = true;
            ...
            for (var i = 0; i <= TabCount - 1; i++)
            {
                ...
                if (i == SelectedIndex)
                {
                    ...
                    Drawer.FillRectangle(
                        ...
                        new Rectangle(Header.X - 3, Header.Y - 3, Header.Width, Header.Height + 5));
        ...
        private void ReplaceTabPages(TabPage Source, TabPage Destination)
        {
            ...
            //this.TabPages[DestinationIndex] = Destination;
            //this.TabPages[SourceIndex] = Source;
